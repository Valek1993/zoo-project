...
def parse_zoo():
    url1 = ["https://zoobaza.by/dlya-koshek/vlazhnyj-korm-dlya-koshek/"]
    count_image = 25
    for i in url1:
        ...
        for i in range(24):
            ...
            count_image += 1
            time.sleep(1)
            print(id_image, price,  name,  title, weight, age_of_the_animal, animal_size, availability, price, description, link, image, manufacturer, old_price, sale,  sep="\n")
            insert(conn, id_image, name, title, weight, age_of_the_animal, animal_size, availability, price, image, description, link, manufacturer, sale, old_price)
